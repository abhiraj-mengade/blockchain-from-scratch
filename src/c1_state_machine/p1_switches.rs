        ...
        match t {
            Toggle::FirstSwitch => {
                if starting_state.first_switch {
                    // If the first switch is on, we turn it off and turn the second switch off as well
                    TwoSwitches {
                        first_switch: false,
                        second_switch: false,
                    }
                } else {
                    // If the first switch is off, we turn it on
                    TwoSwitches {
                        first_switch: true,
            ...
            Toggle::SecondSwitch => {
                if starting_state.second_switch {
                    // If the second switch is on, we turn it off
                    TwoSwitches {
                        first_switch: starting_state.first_switch,
                        second_switch: false,
                    }
                } else {
                    // If the second switch is off, we turn it on
                    TwoSwitches {
                        first_switch: starting_state.first_switch,
                        second_switch: true,
                    }
